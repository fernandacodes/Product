...
Route::middleware('auth:api')->group(function () {
    ...
    // Rotas para gerenciamento de categorias de tarefas
    ...
    Route::get('/tasks/report', [TaskController::class, 'report'])->name('tasks.report'); // Relatórios e estatísticas
    Route::get('/tasks/export', [TaskController::class, 'export'])->name('tasks.export'); // Exportação de tarefas (CSV ou PDF)
});
